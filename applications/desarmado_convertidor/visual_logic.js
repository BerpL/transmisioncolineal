/**
 * Generated by Verge3D Puzzles v.3.8.0 pre3
 * Tue Dec 21 2021 14:24:21 GMT-0500 (hora estándar de Perú)
  ...
  if (animation_counter == 1) {
    ...
    registerSetTimeout(5, function() {
      ...
      registerOnClick('Cruceta Carvanica', false, false, [0,1,2], function() {
        ...
        operateAnimation('PLAY', getObjectsFrom(['ALL_OBJECTS'], 'ALL'), 1, 480, 'LoopOnce', 1,
  ...
  if (animation_counter == 2) {
    ...
    registerSetTimeout(5, function() {
      ...
      registerOnClick('Carcasa_Convertidor', false, false, [0,1,2], function() {
        ...
        operateAnimation('PLAY', getObjectsFrom(['ALL_OBJECTS'], 'ALL'), 2600, 2740, 'LoopOnce', 1,
                function() {}, undefined, false);
  ...
  if (animation_counter == 3) {
    ...
    registerSetTimeout(5, function() {
      ...
      registerOnClick('Tapa 01_Carcasa', false, false, [0,1,2], function() {
        ...
        operateAnimation('PLAY', getObjectsFrom(['ALL_OBJECTS'], 'ALL'), 480, 1200, 'LoopOnce', 1,
                function() {}, undefined, false);
