 ...
 * Fri Jan 07 2022 16:35:59 GMT-0500 (hora estándar de Perú)
...
registerOnClick('Box050', false, false, [0,1,2], function() {
  tweenCamera('PC1', 'VC1', 1, function() {}, 0);
}, function() {});

registerOnClick('pulpeadora', false, false, [0,1,2], function() {
  tweenCamera('pc2', 'vc2', 1, function() {}, 0);
}, function() {});

registerOnClick('Box012', false, false, [0,1,2], function() {
  tweenCamera('PC1', 'VC1', 1, function() {}, 0);
}, function() {});


operateAnimation('PLAY', getAnimations(['GROUP', 'planta_piloto']), 0, 1000, 'AUTO', 1,
