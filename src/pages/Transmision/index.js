  ...
  return (
    <Container>
      ...
      <Controls>
        ...
        <LeftArrow
          id="left_arrow_red"
          src="applications/transmision/img/left_arrow_red.svg"
          alt="left arrow"
          draggable="false"
          style={{ display: "none" }}
        />
        ...
        <RightArrow
          id="right_arrow_red"
          src="applications/transmision/img/right_arrow_red.svg"
          alt="right arrow"
          draggable="false"
          style={{ display: "none" }}
        />
        ...
        <TopArrow
          id="top_arrow_red"
          src="applications/transmision/img/top_arrow_red.svg"
          alt="top arrow"
          draggable="false"
          style={{ display: "none" }}
        />
        ...
        <BotArrow
          id="bot_arrow_red"
          src="applications/transmision/img/bot_arrow_red.svg"
          alt="bot arrow"
          draggable="false"
          style={{ display: "none" }}
        />
