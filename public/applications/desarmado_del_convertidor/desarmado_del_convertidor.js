...
(function() {
    ...
    var sceneURL = params.load ? params.load : '__URL__desarmado_del_convertidor.gltf'.replace('__URL__', '');
    if (!sceneURL) {
...
function prepareExternalInterface(app) {
    ...
    app.ExternalInterface.emitirEstadoAnimacion = function () {
        var input = window.parent.document.querySelector('#estado_animacion');
